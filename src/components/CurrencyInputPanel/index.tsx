...
import { Button, ChevronDownIcon, Text } from 'toolkitUI'
...
const InputPanel = styled.div<{ hideInput?: boolean }>`
  ...
  z-index: 1;
`
const Container = styled.div<{ hideInput: boolean; isWarning: boolean }>`
  border-radius: 16px;
...
export default function CurrencyInputPanel({
  ...
  return (
    <InputPanel id={id}>
      <Container hideInput={hideInput} isWarning={isWarning}>
        {!hideInput && (
          <LabelRow>
            <RowBetween>
        ...
        <InputRow style={hideInput ? { padding: '0', borderRadius: '8px' } : {}} selected={disableCurrencySelect}>
          ...
          {presetTkn && (
            <Text fontSize="16px" style={{ display: 'inline', cursor: 'pointer' }}>
              {tknSymbol}
            </Text>
          )}
        </InputRow>
